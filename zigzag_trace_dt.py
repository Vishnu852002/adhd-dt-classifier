...
Performs Decision Tree Classification on the ZigZag Trace dataset
...
# Load dataset
data_path = '/content/drive/MyDrive/ADHD_MainProject/Zigzag_trace.csv'
...
# Save results
output_path = '/content/drive/MyDrive/ADHD_MainProject/result/DT_Task1_SFFS.csv'
