...
Performs Decision Tree Classification on the PL Predict dataset
...
# Load dataset
data_path = '/content/drive/MyDrive/ADHD_MainProject/Pl_predict.csv'
...
# Save results
output_path = '/content/drive/MyDrive/ADHD_MainProject/result/DT_Task4_SFFS.csv'
