...
Performs Decision Tree Classification on the PL Trace dataset
...
# Load dataset
data_path = '/content/drive/MyDrive/ADHD_MainProject/Pl_trace.csv'
...
# Save results
output_path = '/content/drive/MyDrive/ADHD_MainProject/result/DT_Task3_SFFS.csv'
